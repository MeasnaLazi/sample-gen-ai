...
async def get_airbnb_tools_async():
...
#         async_main(
#             (
#                 "Find me an airbnb in Siemreap, Aug 9th, to Aug 13th, no flights nor itinerary needed. "
#                 "No need to confirm, simply return 5 choicess, remember to include urls."
#                 "Please find the price between $20 to $50."
#             )
#         )
#     )
